...
const processSteps=[
 {number:"01",title:"A private first conversation",text:"Share your concern, symptoms and relevant history in a respectful setting. Bring previous reports, prescriptions and a list of current medicines.",image:"/gynecology-consultation-hero.png",alt:"Representative private doctor consultation"},
 {number:"02",title:"Individual clinical assessment",text:"Your history and symptoms are reviewed carefully. Examination or investigations are suggested only when the doctor considers them appropriate.",image:"/maternity-consultation.png",alt:"Representative maternity consultation with a gynecologist"},
 {number:"03",title:"A clearly explained care plan",text:"Possible treatment, follow-up or referral is explained in simple language so you understand the next step before leaving the clinic.",image:"/womens-clinic-reception.png",alt:"Representative women's clinic reception"},
];
...
export default async function DoctorProfile({params}:{params:Promise<{slug:string}>}){
 ...
 return <><Header/><main className="doctor-editorial doctor-profile-v2">
  <section className="doctor-v2-hero">
   ...
   <div className="doctor-v2-hero-art"><Image src="/gynecology-consultation-hero.png" alt="Representative gynecology and women’s healthcare" fill priority sizes="(max-width:900px) 100vw,52vw"/><div><span>Women’s Health</span><b>Care with dignity, privacy and clear guidance.</b></div></div>
  </section>
  ...
  <section className="doctor-v2-why"><div className="doctor-v2-why-copy"><p className="eyebrow">Why choose this care approach</p><h2>Professional care, explained without confusion.</h2><ul><li><b>Respectful conversations</b><span>Your concerns are heard without judgement.</span></li><li><b>Individual decisions</b><span>Recommendations depend on your clinical needs.</span></li><li><b>Simple explanations</b><span>Questions and next steps are discussed clearly.</span></li></ul></div><div className="doctor-v2-collage"><div><Image src="/gynecology-consultation-hero.png" alt="Representative doctor consultation" fill sizes="30vw"/></div><div><Image src="/maternity-consultation.png" alt="Representative maternity care" fill sizes="25vw"/></div><div><Image src="/womens-clinic-reception.png" alt="Representative clinic reception" fill sizes="25vw"/></div></div></section>
